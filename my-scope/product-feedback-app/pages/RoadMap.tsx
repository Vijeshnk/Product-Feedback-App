  ...
  return (
    <>
      ...
      <Grid
        container
        spacing={3}
        sx={{ paddingX: '100px', justifyContent: 'center', marginTop: '100px' }}
      >
        <Grid item>
          <Box width="300px">
            <Typography
            ...
            <Typography sx={{ fontWeight: 500, color: 'hsl(224,20%,49%)' }}>
      ...
      <Grid
        container
        spacing={3}
        sx={{ paddingX: '100px', justifyContent: 'center', marginTop: '3px' }}
      >
        <Grid item>
          <Box width="300px">
            <Card
            ...
            >
              <CardContent>
                <List sx={{ listStyleType: 'disc', ml: 1, mt: -4.5 }}>
                  ...
                  <Typography paragraph sx={{ color: 'hsl(224,20%,49%)' }}>
                    Easier to search23322 for solutions based on a specific
                    stack.
                  </Typography>
                </List>
                {/* imported component */}
